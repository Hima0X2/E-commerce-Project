        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <a class="nav-link" href="{{ route('products') }}">view all products <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="#"><h4>Tittle goes here</h4></a>
                <h6>$20.45</h6>
                <p>ShopSizzle is free CSS template provided by TemplateMo.</p>
                <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
...
Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et, consequuntur, modi mollitia corporis ipsa voluptate corrupti eum ratione ex ea praesentium quibusdam? Aut, in eum facere corrupti necessitatibus perspiciatis quis.</p>
          ...
          <div class="col-md-6">
            ...
            <img src="assets/images/feature-image.jpg" alt="" style="width: 350px; height: auto;">
            </div>
          </div>
        </div>
      </div>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="inner-content">
            <p>Copyright © 2024 :ShopSizzle </p></div>
          </div>
        </div>
      </div>
    </footer>
